...
(async () => {
    ...
    let secretKey = Uint8Array.from("CQp7cpyGiz8Q6fwnjbsPeasQnEkzEmbj2co9WfeHBS5Q");
    ...
    const destMint: PublicKey = new web3.PublicKey("CQp7cpyGiz8Q6fwnjbsPeasQnEkzEmbj2co9WfeHBS5Q");
